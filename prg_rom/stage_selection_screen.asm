...
STAGE_SELECT_SPRITE($40, TILE_MINI_STAGE_PIT_3, $00, $B8)
STAGE_SELECT_SPRITE($40, TILE_MINI_STAGE_PIT_0, $00, $C0)
STAGE_SELECT_SPRITE($40, TILE_MINI_STAGE_PIT_0, $00, $C8)
                       
STAGE_SELECT_SPRITE($48, TILE_MINI_STAGE_PIT_1, $00, $B0)
STAGE_SELECT_SPRITE($48, TILE_MINI_STAGE_PIT_0, $00, $B8)
STAGE_SELECT_SPRITE($48, TILE_MINI_STAGE_PIT_0, $00, $C0)
STAGE_SELECT_SPRITE($48, TILE_MINI_STAGE_PIT_1, $40, $C8)
                       
STAGE_SELECT_SPRITE($50, TILE_MINI_STAGE_PIT_2, $00, $B0)
STAGE_SELECT_SPRITE($50, TILE_MINI_STAGE_PIT_0, $00, $B8)
STAGE_SELECT_SPRITE($50, TILE_MINI_STAGE_PIT_3, $40, $C0)
STAGE_SELECT_SPRITE($50, TILE_MINI_STAGE_PIT_2, $40, $C8)
; Down left
