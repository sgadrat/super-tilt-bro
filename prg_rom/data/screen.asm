...
.byt ZIPNT_ZEROS(32*4+7)
.byt                                     $46,  $48, $3b, $49, $49,  $3b, $50,ZIPZ, $4b,  $44,ZIPZ, $38, $45,  $4b, $4a, $45, $44,
;    -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------
...
nametable_gameover:
.byt ZIPNT_ZEROS(32*3+18)
.byt                                                                                               $02, $02,  $4c, $3f, $39, $4a,  $45, $3f, $48, $3b,  $02, $02
;    -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------
.byt ZIPNT_ZEROS(2+18)
.byt                                                                                               $02, $02,  $02, $02, $02, $02,  $02, $02, $02, $02,  $02, $02
.byt ZIPNT_ZEROS(2+6)

.byt                                $2b, $2c,  ZIPNT_ZEROS(10),
.byt                                                                                               $02, $02,  $40, $45, $4b, $3b,  $4b, $48, ZIPNT_ZEROS(3), $02
.byt ZIPNT_ZEROS(2+4)
.byt                      $2d, $2e, $2f, $30
...
.byt $01, $01, $01, $01,  $01, $01, $01, ZIPNT_ZEROS(17),                                                                          $01, $01, $01, $01,  $01, $01, $01, $01
.byt $01, $01, $01, $01,  $01, $01, $01, ZIPNT_ZEROS(2)
.byt                                                $46, $48, $3b,  $49, $49, $3b, $50,  $02, $49, $4a, $37, $48,$4a,ZIPNT_ZEROS(2),$01,$01, $01, $01,  $01, $01, $01, $01
.byt $01, $01, $01, $01,  $1f, $20, $01, ZIPNT_ZEROS(17),                                                                          $01, $01, $1f, $20,  $01, $01, $01, $01
...
.byt %10101010, %10101010, %10101111, %10101111, %10101111, %10101111, %10101010, %10101010
.byt %10101010, %10101010, %10101010, %10101010, %10101010, %10101010, %10101010, %10101010
...
.byt ZIPNT_ZEROS(8+8)
.byt                                           $fc, $e6, $02, $02,  $e7, $02, $43, $4b,  $49, $3f, $47, $4b,  $3b, $02, $02, $fd
.byt ZIPNT_ZEROS(8+8)
...
.byt                                           $fc, $02, $e5, $e5,  $02, $02, $02, $02,  $02, $02, $02, $02,  $02, $02, $02, $fd
.byt ZIPNT_ZEROS(8+8)
.byt                                           $fc, $e6, $02, $02,  $e7, $02, $02, $4c,  $3f, $3b, $49, $02,  $02, $02, $02, $fd
.byt ZIPNT_ZEROS(8+8)
.byt                                           $fc, $e6, $02, $02,  $e7, $f5, $02, $02,  $02, $02, $02, $02,  $f6, $02, $02, $fd
;    -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  ------------------
.byt ZIPNT_ZEROS(8+8)
...
.byt                                           $fc, $02, $e5, $e5,  $02, $02, $02, $02,  $02, $02, $02, $02,  $02, $02, $02, $fd
.byt ZIPNT_ZEROS(8+8)
.byt                                           $fc, $e6, $02, $02,  $e7, $40, $45, $4b,  $3b, $4b, $48, $02,  $32, $02, $02, $fd
.byt ZIPNT_ZEROS(8+8)
.byt                                           $fc, $e6, $02, $02,  $e7, $f5, $02, $02,  $02, $02, $02, $02,  $f6, $02, $02, $fd
;    -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  ------------------
.byt ZIPNT_ZEROS(8+8)
...
;    -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  ------------------
.byt ZIPNT_ZEROS(8+32+32+9)
.byt                                                $46, $48, $3b,  $49, $49, $3b, $50,  $02, $49, $4a, $37,  $48, $4a
;    -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  ------------------
.byt ZIPNT_ZEROS(10+32+32+32)
...
.byt ZIPNT_ZEROS(32+32+32+2)
.byt           $e9, $ea,  $02, $49, $3b, $42,  $3b, $39, $4a, $3f,  $45, $44, $02, $3a,  $02, $37, $48, $3b,  $44, $3b, $02, $02,  $02, $02, $02, $02,  $02, $02
;    -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  ------------------
.byt ZIPNT_ZEROS(2+2)
.byt           $eb, $ec
...
;    -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  ------------------
.byt ZIPNT_ZEROS(2+2)
.byt           $fc, $42,  $3b, $02, $46, $42,  $37, $4a, $3b, $37,  $4b, $fd, ZIPNT_ZEROS(4),      $fc, $42,  $3b, $02, $3d, $45,  $4b, $3c, $3c, $48,  $3b, $fd
.byt ZIPNT_ZEROS(2+2)
...
.byt           $fc, $02,  $02, $02, $ff, $ff,  $ff, $ff, $02, $02,  $02, $fd, ZIPNT_ZEROS(4),      $fc, $02,  $02, $02, $ff, $ff,  $ff, $ff, $02, $02,  $02, $fd
.byt ZIPNT_ZEROS(2+2)
.byt           $fc, $42,  $3b, $02, $4c, $3b,  $48, $4a, $3f, $3d,  $3b, $fd, ZIPNT_ZEROS(4),      $fc, $02,  $42, $37, $02, $46,  $48, $45, $3f, $3b,  $02, $fd
.byt ZIPNT_ZEROS(2+2)
.byt           $f9, $fe,  $fe, $fe, $fe, $fe,  $fe, $fe, $fe, $fe,  $fe, $fa, ZIPNT_ZEROS(4),      $f9, $fe,  $fe, $fe, $fe, $fe,  $fe, $fe, $fe, $fe,  $fe, $fa
.byt ZIPNT_ZEROS(2+32+32+9)
.byt                                                $46, $48, $3b,  $49, $49, $3b, $50,  $02, $49, $4a, $37,  $48, $4a
;    -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  ------------------
.byt ZIPNT_ZEROS(10+32+32+32)
.byt %11111111, %11111111, %11111111, %11111111, %11111111, %11111111, %11111111, %11111111
