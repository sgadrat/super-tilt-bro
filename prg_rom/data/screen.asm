...
; Background
.byt $21,$0d,$12,$00, $21,$0d,$21,$00, $21,$0d,$28,$00, $21,$00,$00,$00
; Sprites
...
.byt                                                     $f7, $f7,  $f7, $f7, $f7, $f7,  $f7, $f7, $f7, $f7,  $f7, $f7
;    -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------
.byt ZIPNT_ZEROS(10+32*5+4)
.byt                      $f7, $f7, $f7, $f7,  $f7, $f7, $f7, $f7,  $f7, ZIPNT_ZEROS(6),                $f7,  $f7, $f7, $f7, $f7,  $f7, $f7, $f7, $f7
;    -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------  -------------------
.byt ZIPNT_ZEROS(4+32+18)
.byt                                                                                               $04, $05,  $06, $07, ZIPNT_ZEROS(8),                           $2b, $2c
.byt ZIPNT_ZEROS(18)
.byt                                                                                               $08, $09,  $0a, $0b, ZIPNT_ZEROS(8),                           $2f, $30
.byt ZIPNT_ZEROS(18)
.byt                                                                                               $0c, $0d,  $0e, $0f
...
.byt                                                     $49, $4a,  $37, $3d, $3b,ZIPZ,  $49, $3b, $42, $3b,  $39, $4a,
;    -------------------  -------------------  -------------------  ------------------   -------------------  -------------------  -------------------  ------------------
.byt ZIPNT_ZEROS(10+32+32+2)
