...
ANIM_HITBOX($01, $02, $0000, $fc00, $0000, $fff8, $02, $07, $f4, $ff) ; enabled, damages, base_h, base_v, force_h, force_v, left, right, top, bottom
...
ANIM_HITBOX($01, $02, $0000, $fc00, $0000, $fff8, $00, $05, $f4, $ff)
