...
ANIM_HITBOX($01, $0a, $fd00, $fd00, $fffb, $fffe, $f4, $00, $06, $0b) ; enabled, damages, base_h, base_v, force_h, force_v, left, right, top, bottom
...
ANIM_HITBOX($00, $0a, $fd00, $fd00, $fffb, $fffe, $fa, $05, $0e, $15)
...
ANIM_HITBOX($00, $0a, $fd00, $fd00, $fffb, $fffe, $04, $09, $0b, $16)
...
ANIM_HITBOX($01, $0a, $0300, $fd00, $0005, $fffe, $ff, $0b, $06, $0b)
...
ANIM_HITBOX($00, $0a, $0300, $fd00, $0005, $fffe, $fa, $05, $0e, $15)
...
ANIM_HITBOX($00, $0a, $0300, $fd00, $0005, $fffe, $f6, $fb, $0b, $16)
