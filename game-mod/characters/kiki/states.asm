...
.(
	...
	.(
		...
		.byt CONTROLLER_INPUT_SPECIAL_DOWN, CONTROLLER_INPUT_SPECIAL_UP,  CONTROLLER_INPUT_ATTACK_UP,     CONTROLLER_INPUT_DOWN_TILT
		...
		.byt <kiki_start_down_spe,          <kiki_start_up_spe,           <kiki_start_up_tilt,            <kiki_start_down_tilt
