...
CHARACTERS_END_TILES = NB_PLAYERS*CHARACTERS_NUM_TILES_PER_CHAR
...
NETWORK_INPUT_LAG = 4
NETWORK_RESEND_BUTTONS_INTERVAL = 16
NETWORK_GAMEOVER_MESSAGE_TIMEOUT = 60
...
HITBOX_OFFSET_FLAGS = 0
HITBOX_OFFSET_LEFT = 1
HITBOX_OFFSET_RIGHT = 2
HITBOX_OFFSET_TOP = 3
HITBOX_OFFSET_BOTTOM = 4
HITBOX_OFFSET_LEFT_MSB = 5
HITBOX_OFFSET_RIGHT_MSB = 6
HITBOX_OFFSET_TOP_MSB = 7
HITBOX_OFFSET_BOTTOM_MSB = 8

INTERLEAVED_HITBOX_OFFSET_FLAGS = HITBOX_OFFSET_FLAGS * NB_PLAYERS
INTERLEAVED_HITBOX_OFFSET_LEFT = HITBOX_OFFSET_LEFT * NB_PLAYERS
INTERLEAVED_HITBOX_OFFSET_RIGHT = HITBOX_OFFSET_RIGHT * NB_PLAYERS
INTERLEAVED_HITBOX_OFFSET_TOP = HITBOX_OFFSET_TOP * NB_PLAYERS
INTERLEAVED_HITBOX_OFFSET_BOTTOM = HITBOX_OFFSET_BOTTOM * NB_PLAYERS
INTERLEAVED_HITBOX_OFFSET_LEFT_MSB = HITBOX_OFFSET_LEFT_MSB * NB_PLAYERS
INTERLEAVED_HITBOX_OFFSET_RIGHT_MSB = HITBOX_OFFSET_RIGHT_MSB * NB_PLAYERS
INTERLEAVED_HITBOX_OFFSET_TOP_MSB = HITBOX_OFFSET_TOP_MSB * NB_PLAYERS
INTERLEAVED_HITBOX_OFFSET_BOTTOM_MSB = HITBOX_OFFSET_BOTTOM_MSB * NB_PLAYERS

; Projectiles constants
PROJECTILE_FLAGS_DEACTIVATED = 0 ;NOTE code can safely assume that this value is zero
PROJECTILE_FLAGS_ACTIVE = 1
PROJECTILE_DATA_SIZE = 9
NB_PROJECTILES_PER_PLAYER = 1
