...
audio_square1_default_note_duration = $060f
audio_square2_default_note_duration = $0610
audio_triangle_default_note_duration = $0611
audio_square1_apu_envelope_byte = $0612
audio_square2_apu_envelope_byte = $0613
audio_square1_apu_timer_low_byte = $0614
audio_square2_apu_timer_low_byte = $0615
audio_triangle_apu_timer_low_byte = $0616
audio_square1_apu_timer_high_byte = $0617
audio_square2_apu_timer_high_byte = $0618
audio_triangle_apu_timer_high_byte = $0619
audio_square1_apu_timer_high_byte_old = $061a
audio_square2_apu_timer_high_byte_old = $061b
audio_triangle_apu_timer_high_byte_old = $061c ; Actually useless for triangle, but allows to easily merge code for pulse/triangle (unused now, triangle timer is handled in a "if triangle" branch) ;TODO remove it once code is stable enough to confidently state that we'll never use it
audio_square1_pitch_slide_lsb = $061d
audio_square2_pitch_slide_lsb = $061e
audio_triangle_pitch_slide_lsb = $061f
audio_square1_pitch_slide_msb = $0620
audio_square2_pitch_slide_msb = $0621
audio_triangle_pitch_slide_msb = $0622

audio_noise_wait_cnt = $0623
audio_noise_apu_envelope_byte = $0624
audio_noise_apu_period_byte = $0625
