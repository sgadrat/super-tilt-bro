...
player_a_hitbox_hit_lsb = player_a_hitbox_base_knock_up_v_low  ;
player_b_hitbox_hit_lsb = player_b_hitbox_base_knock_up_v_low  ; Custom hitbox parameters
player_a_hitbox_hit_msb = player_a_hitbox_base_knock_up_v_high ;
player_b_hitbox_hit_msb = player_b_hitbox_base_knock_up_v_high ;
