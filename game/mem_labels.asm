...
audio_square1_current_opcode = $0603
audio_square2_current_opcode = $0604
audio_triangle_current_opcode = $0605
audio_square1_current_opcode_msb = $0606
audio_square2_current_opcode_msb = $0607
audio_triangle_current_opcode_msb = $0608
audio_square1_wait_cnt = $0609
audio_square2_wait_cnt = $060a
audio_triangle_wait_cnt = $060b
audio_square1_default_note_duration = $060c
audio_square2_default_note_duration = $060d
audio_triangle_default_note_duration = $060e
audio_square1_apu_envelope_byte = $060f
audio_square2_apu_envelope_byte = $0610
audio_square1_apu_timer_low_byte = $0611
audio_square2_apu_timer_low_byte = $0612
audio_triangle_apu_timer_low_byte = $0613
audio_square1_apu_timer_high_byte = $0614
audio_square2_apu_timer_high_byte = $0615
audio_triangle_apu_timer_high_byte = $0616
audio_square1_apu_timer_high_byte_old = $0617
audio_square2_apu_timer_high_byte_old = $0618
audio_triangle_apu_timer_high_byte_old = $0619 ; Actually useless for triangle, but allows to easily merge code for pulse/triangle (unused now, triangle timer is handled in a "if triangle" branch) ;TODO remove it once code is stable enough to confidently state that we'll never use it
audio_square1_pitch_slide_lsb = $061a
audio_square2_pitch_slide_lsb = $061b
audio_triangle_pitch_slide_lsb = $061c
audio_square1_pitch_slide_msb = $061d
audio_square2_pitch_slide_msb = $061e
audio_triangle_pitch_slide_msb = $061f
