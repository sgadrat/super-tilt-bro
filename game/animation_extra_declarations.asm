...
#define ANIM_HITBOX(enabled,damages,base_h,base_v,force_h,force_v,left,right,top,bottom) .byt $01, left, right, <base_h, >base_h, <force_h, >force_h, top, bottom, <base_v, >base_v, <force_v, >force_v, damages, enabled
