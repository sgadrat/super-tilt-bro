...
STAGE_THEPLANK_BLAST_LEFT = STAGE_BLAST_LEFT
STAGE_THEPLANK_BLAST_RIGHT = STAGE_BLAST_RIGHT
STAGE_THEPLANK_BLAST_TOP = STAGE_BLAST_TOP
STAGE_THEPLANK_BLAST_BOTTOM = STAGE_BLAST_BOTTOM
