...
STAGE_BUMPER($90, $a0, $0f, $2f, $0c, $0200, $10, $01, $01) ; left, right, top, bot, damages, base, force, horizontal_direction, vertical_direction
PLATFORM($98, $fe, $0f, $2f) ; left, right, top, bot
STAGE_BUMPER($70, $88, $27, $3f, $0c, $0200, $10, $01, $01) ; left, right, top, bot, damages, base, force, horizontal_direction, vertical_direction
