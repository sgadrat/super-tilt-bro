...
.(
	...
	apply_fadeout:
	;Fallthrough to stage_arcade_btt01_fadeout_update
.)
...
;
; Overwrites registers, tmpfield1 to tmpfield4
stage_arcade_btt01_fadeout_update:
.(
	...
	lda stage_arcade_btt01_fadeout_lsb, x
	sta payload
	lda stage_arcade_btt01_fadeout_msb, x
	sta payload+1
...
+stage_arcade_btt01_tick = stage_arcade_btt01_repair_screen
...
stage_arcade_btt01_repair_screen:
.(
	...
	.(
		...
		beq ok
			jmp stage_arcade_btt01_fadeout_update
	...
	.byt $00, $00, $00, $00, $00, $04, $01, $00
	.byt $00, $00, $00, $00, $00, $00, $00, $00
	.byt $00, $00, $00, $00, $00, $00, $05, $00
	bot_attibutes:
	.byt $23, $e0, $20
	.byt $00, $05, $00, $00, $00, $00, $00, $00
	.byt $00, $00, $00, $00, $00, $00, $00, $00
