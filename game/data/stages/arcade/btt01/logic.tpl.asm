...
!define "town" {cloud + tileset_new_cloud_size}
...
!define "extra_init" {
	...
	water = bg+4*16
	LOAD_TILESET_REMAP(cutscene_sinbad_story_common_water_tileset, cutscene_sinbad_story_common_tilesets_bank, water, #0,#1,#3,#2, CURRENT_BANK_NUMBER)

	cloud = water + cutscene_sinbad_story_common_water_tileset_end - cutscene_sinbad_story_common_water_tileset_tiles
	LOAD_TILESET_REMAP(tileset_new_cloud, TILESET_NEW_CLOUD_BANK_NUMBER, cloud, #3,#1,#2,#3, CURRENT_BANK_NUMBER)
