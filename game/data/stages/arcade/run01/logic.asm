...
.(
	...
	apply_fadeout:
	;Fallthrough to stage_arcade_run01_fadeout_update
.)
...
;
; Overwrites registers, tmpfield1 to tmpfield4
stage_arcade_run01_fadeout_update:
.(
	...
	lda stage_arcade_run01_fadeout_lsb, x
	sta payload
	lda stage_arcade_run01_fadeout_msb, x
	sta payload+1
...
+stage_arcade_run01_tick = stage_arcade_run01_repair_screen
...
stage_arcade_run01_repair_screen:
.(
	...
	.(
		...
		beq ok
			jmp stage_arcade_run01_fadeout_update
