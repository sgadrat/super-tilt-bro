...
!define "gameplay" {!place "town" + arcade_town_tileset_size}
!define "extra_init" {
	; Load colon tile
	...
	LOAD_TILESET_REMAP(tileset_new_cloud, TILESET_NEW_CLOUD_BANK_NUMBER, !place "cloud", #2,#1,#2,#3 , CURRENT_BANK_NUMBER)
