...
#define OOS_PLATFORM(left,right,top,bot) .byt STAGE_ELEMENT_PLATFORM, <left, >left, <right, >right, <top, >top, <bot, >bot
#define OOS_SMOOTH_PLATFORM(left,right,top) .byt STAGE_ELEMENT_SMOOTH_PLATFORM, <left, >left, <right, >right, <top, >top
