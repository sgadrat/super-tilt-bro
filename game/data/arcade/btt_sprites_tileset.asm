...
TILE_ARCADE_BTT_SPRITES_TILESET_TARGET_DARK = $c0+(*-arcade_btt_sprites_tileset_tiles)/16
.byt %00111100, %01111110, %11111111, %11111111, %11111111, %11111111, %01111110, %00111100
.byt %00000000, %00000000, %00000000, %00000000, %00000000, %00000000, %00000000, %00000000
TILE_ARCADE_BTT_SPRITES_TILESET_TARGET_EXPLODE = $c0+(*-arcade_btt_sprites_tileset_tiles)/16
