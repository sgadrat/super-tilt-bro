...
;     - difficulty being computing the cuttable_duration table from "duration" parameter which contains pal+ntsc variants
...
.(
	...
	anim_duration_table({anim}_dur_pal-{cuttable_duration}, cuttable_duration)
