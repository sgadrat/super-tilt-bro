...
STNP_CLI_MSG_TYPE_PING = 2
STNP_CLI_MSG_TYPE_ABORT_CONNECTION = 3
...
STNP_SRV_MSG_TYPE_PONG = 5

STNP_MSG_TYPE_FIELD = 0

STNP_CONNECTED_FIELD_CONNECTION_QUALITY = 1
...
STNP_START_GAME_FIELD_PA_PING = 9
STNP_START_GAME_FIELD_PB_PING = 12
STNP_START_GAME_FIELD_FRAMERATES = 15
STNP_START_GAME_FIELD_COUNTDOWN = 16

STNP_GAMEOVER_FIELD_WINNER_PLAYER_NUMBER = 1
