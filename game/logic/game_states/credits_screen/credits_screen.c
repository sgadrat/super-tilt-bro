...
static void show_current_page() {
	...
	static uint8_t const attributes_order_bits[] = {
		ATT(0,1,1,1), ATT(1,1,1,0), ATT(1,1,0,1), ATT(1,0,1,1),
		ATT(0,0,1,1), ATT(1,1,0,0), ATT(1,1,0,0), ATT(0,0,1,1), ATT(0,0,0,1), ATT(0,1,0,0),
		ATT(0,0,0,1), ATT(1,0,0,0), ATT(1,0,0,0), ATT(0,0,1,0),
