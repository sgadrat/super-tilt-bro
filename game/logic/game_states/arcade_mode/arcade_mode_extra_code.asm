...
+arcade_encounters:
	...
	ARCADE_RUN(stage_arcade_run01_index, 8,0, 5,0)
	ARCADE_CUTSCENE(cutscene_sinbad_story_sinbad_encounter, cutscene_sinbad_story_sinbad_encounter_bank)
	ARCADE_FIGHT(0, 1, 0, stage_arcade_fight_port_index, 30,0, 15,0)
	ARCADE_TARGETS(stage_arcade_btt01_index, 30,0, 18,0)
	ARCADE_CUTSCENE(cutscene_sinbad_story_kiki_encounter, cutscene_sinbad_story_kiki_encounter_bank)
	ARCADE_FIGHT(1, 2, 0, stage_arcade_fight_town_index, 40,0, 20,0)
	ARCADE_RUN(stage_arcade_run02_index, 15,0, 9,0)
	ARCADE_CUTSCENE(cutscene_sinbad_story_pepper_encounter, cutscene_sinbad_story_pepper_encounter_bank)
	ARCADE_FIGHT(2, 3, 0, stage_arcade_fight_wall_index, 40,0, 20,0)
	ARCADE_TARGETS(stage_arcade_btt02_index, 30,0, 18,0)
