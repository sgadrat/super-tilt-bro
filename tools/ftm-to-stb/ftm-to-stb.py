...
music = ftmmanip.remove_instruments(music, arp_force_absolute_notes=True) # May need arp_force_absolute_notes=True for some Famitracker tracks (see docstring)
